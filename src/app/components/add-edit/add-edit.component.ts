...
import {EmpServiceService} from "../../services/service.service";
...
export class AddEditComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if(this.currentEmp._id!=0) {
      ...
      this.Date_Of_Birth = this.currentEmp.Date_Of_Birth;
  ...
  AddEmp() {
    ...
    if(this.currentEmp._id!=0)
    {
      ...
      this.currentEmp.DateOfBirth=this.Date_Of_Birth;
      ...
      const emp: Employee = new Employee(this.Name, this.Date_Of_Birth, this.Location, this.Salary, this.DepartmentId, this.PhoneNumber);
